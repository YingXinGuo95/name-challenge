import { GameState } from "@/app/challenges/name-100-countries/_lib/types";

const STORAGE_KEY = "name100countries_v1";
...
const SUBMISSION_KEY = "name100countries_submission_v1";
