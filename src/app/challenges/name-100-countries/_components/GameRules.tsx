...
const rules = [
  {
    icon: Target,
    label: "Goal",
    text: `Name ${TOTAL} countries — any sovereign state or widely-recognized territory, verified locally.`,
  },
  {
    icon: CheckCircle,
    label: "How to play",
  ...
  },
  {
    icon: Ban,
    label: "No duplicates",
    text: "Each country can only be used once. Duplicates won't count.",
  },
  {
    icon: Timer,
    label: "Timer",
  ...
  return (
    <div className="flex w-[260px] flex-col gap-4">
      ...
      <p className="text-[11px] font-medium leading-relaxed text-muted-foreground">
        ...
        Think across continents — Africa, Asia, Europe, North America, South
        America, and Oceania!
      </p>

      {/* Link to full rules page */}
      <a
        href="/challenges/name-100-countries/rules"
        className="text-[11px] font-extrabold uppercase tracking-wider text-[#4CAF50] hover:underline"
      >
        Read full rules →
      </a>
    </div>
