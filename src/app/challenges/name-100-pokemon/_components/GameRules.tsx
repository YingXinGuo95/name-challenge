...
const rules = [
  {
    icon: Target,
    label: "Goal",
    text: `Name ${TOTAL} Pokémon — any Pokémon from any generation, verified locally.`,
  },
  {
    icon: CheckCircle,
    label: "How to play",
  ...
  },
  {
    icon: Ban,
    label: "No duplicates",
    text: "Each Pokémon can only be used once. Duplicates won't count.",
  },
  {
    icon: Timer,
    label: "Timer",
  ...
  return (
    <div className="flex w-[260px] flex-col gap-4">
      ...
      <p className="text-[11px] font-medium leading-relaxed text-muted-foreground">
        ...
        Think across generations — Kanto, Johto, Hoenn, Sinnoh, Unova, Kalos,
        Alola, Galar, and Paldea!
      </p>

      {/* Link to full rules page */}
      <a
        href="/challenges/name-100-pokemon/rules"
        className="text-[11px] font-extrabold uppercase tracking-wider text-[#FFCB05] hover:underline"
      >
        Read full rules →
      </a>
    </div>
