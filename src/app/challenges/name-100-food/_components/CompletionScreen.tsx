...
export function CompletionScreen({
  ...
  function buildShareText(): string {
    if (submissionResult) {
      return `🍽️ I ranked #${submissionResult.rank} — named ${targetCount} foods in ${elapsed}!\n\nCan you beat my score? Play Name 100 Food Challenge!`;
    }
    return `🍽️ I just named ${targetCount} foods in ${elapsed}!\n\nCan you beat my score? Play Name 100 Food Challenge!`;
  }
  ...
  const handleCopyImage = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        a.href = url;
        a.download = "name-100-food-result.png";
        a.click();
