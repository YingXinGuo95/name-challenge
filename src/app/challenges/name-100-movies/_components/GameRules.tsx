...
const rules = [
  {
    icon: Target,
    label: "Goal",
    text: `Name ${TOTAL} famous movies — verified by Wikidata film data.`,
  },
  {
    icon: CheckCircle,
    label: "How to play",
    text: "Type a movie title and press Enter or click Add. Each valid movie counts toward your total.",
  },
  {
    icon: Ban,
    label: "No duplicates",
    text: "Each movie can only be used once. Duplicates won't count.",
  },
  {
    icon: Timer,
    label: "Timer",
  ...
  return (
    <div className="flex w-[260px] flex-col gap-4">
      ...
      <p className="text-[11px] font-medium leading-relaxed text-muted-foreground">
        ...
        Think across genres — sci-fi, Oscars, animation, action, classics, thrillers, and comedy!
      </p>

      {/* Link to full rules page */}
      <a
        href="/challenges/name-100-movies/rules"
        className="text-[11px] font-extrabold uppercase tracking-wider text-[#9333EA] hover:underline"
      >
        Read full rules →
      </a>
    </div>
