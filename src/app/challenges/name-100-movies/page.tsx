...
const gameSchema = {
  ...
  description:
    "A trivia challenge to name 100 famous movies — verified by Wikidata film data.",
  url: pageUrl,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "All movie titles verified against Wikidata film records count. From feature films to animated movies and classics.",
      },
    },
    {
      "@type": "Question",
